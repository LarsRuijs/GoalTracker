...
namespace UnitTests
{
    ...
    class GoalTests
    {
        ...
        public void TestCreateGoalRequiredFields()
        {
            ...
            // Logic aanroepen
            // Check fail 1 : goal1
            failList.Add(gLogic.CreateGoal(goal1));
            // Check fail 2 : goal2
            failList.Add(gLogic.CreateGoal(goal2));

            // Check success 1 : goal3
            successList.Add(gLogic.CreateGoal(goal2));
        ...
        {
            var goal1 = new Goal() { Title = "This is goal1", StartDT = Convert.ToDateTime(""), EndDT = Convert.ToDateTime("2017-06-04") };
            ...
            var goal4 = new Goal() { Title = "This is goal4", StartDT = Convert.ToDateTime(""), EndDT = Convert.ToDateTime("2018-06-10") };
            ...
            failList.Add(gLogic.CreateGoal(goal2));
            // Check fail 3 : goal3
            failList.Add(gLogic.CreateGoal(goal3));

            // Check success 1 : goal4
            successList.Add(gLogic.CreateGoal(goal4));
            // Check success 2 : goal5
            successList.Add(gLogic.CreateGoal(goal5));
